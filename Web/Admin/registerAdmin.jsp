...
<form id="userForm" method="post" class="form-horizontal" style="display: none;" action="../RegisterAdminServlet">
    <div class="form-group">
        <label class="col-xs-3 control-label">管理员工号</label>
        <div class="col-xs-3">
            <%DBConc dc = new DBConc();
                int newId = dc.GetNewId("admin","id");
            %>
    ...
    <div class="form-group">
        <label class="col-xs-3 control-label">用户权限</label>
        <div class="col-xs-5">
            <input type="text" class="form-control" name="power" value="0" readonly="readonly"/>
        </div>
    </div>
