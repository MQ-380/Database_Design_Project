...
<main role="main">
    <div class="container">
        ...
        <form class="form-inline" action="../ConsultInpatientInformationServlet" method="post">
            <div class="form-group">
                <input type="hidden" name="from" value="cancel">
                <label for="InpatientID">直接选择住院病人</label>
                <select class="form-control" id="InpatientID" name="InpatientID">
                    <%
                        Map<String,String> ans = db.getAllInpatient();
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-default" id="searching">查询</button>
            </div>
        </form>
    ...
    <div class="container">
        <div class="table-responsive">
            ...
            <button type="submit" class="btn btn-danger" id="yes">确认出院</button>
        </div>
    </div>
    <%
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">成功出院</h4>
                </div>
                <div class="modal-body">
                    <p>此病人已经成功出院</p>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" data-dismiss="modal" id="closed">确定</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="false">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">出院失败</h4>
                </div>
                <div class="modal-body">
                    <p>由于各种原因，此病人出院失败，请重试</p>
                </div>
                <div class="modal-footer">
