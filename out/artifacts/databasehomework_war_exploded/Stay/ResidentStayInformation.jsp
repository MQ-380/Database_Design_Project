...
<main role="main">
    <div class="container">
        <form class="form-inline" action="../ConsultDoctorInpatientServlet" method="post">
            <div class="form-group">

                <label for="DoctorID">医生姓名</label>
                <select class="form-control" id="DoctorID" name="residentId">
                    <%DBConc db = new DBConc();
                        Map<String,String> ans = db.getResident();
    ...
    <div class="container">
        ...
        <div class="container">
            <%
                ...
                if(residentName!=null && !((String) session.getAttribute("residentName")).isEmpty()){
            %>
            <h4><%=residentName%>医生收治的住院病患情况</h4>
            <%
                }
    ...
    <div class="container">
        <div class="table-responsive">
            ...
            >
                ...
                <%
                    ArrayList<StayInformation> inpatients = (ArrayList<StayInformation>)session.getAttribute("inpatients");
                    if(inpatients!=null){
